...
### Day4: August 3, 2018
**Progress:** Read about Applications of Blockchain and Cryptokitties 
...
**Links:** 
1. [Real World Applications Of Blockchain](https://blockgeeks.com/guides/blockchain-applications-real-world/ …)
...
### Day 8: August 7, 2018
**Progress:** 
1. Read about why Web 3.0 matters
2. Read about Blockchain Technology stack behind Web 3.0
...
2. [Blockchain Technology Stack Behind Web 3.0](https://101blockchains.com/web-3-0-blockchain-technology-stack/)
...
**Progress:** 
1. Watched Blockchain for Supply Chain by [@SirajRaval](https://twitter.com/sirajraval?lang=en)
...
**Links:** 
1. [Blockchain for Supply Chain - Siraj Raval](https://www.youtube.com/watch?v=Z6HS1bSZzHk&feature=youtu.be)
...
2. No Comments on Iran’s National Cryptocurrency. :joy:
...
2. Sidechains are extensions to existing Blockchain which help in the:
   - **Scaling** of Decentralized Applications by running computations on itself instead on the actual Blockchain.
   - **Securing** assets by transferring them over to the Sidechain as NFT while keeping the original value secured on the main Blockchain.
...
2. PAXOS is one of the earliest suggested ways to achieve consensus. It’s difficult to explain it theoretically but easy to understand it in practical. 
